        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GovtId = table.Column<string>(type: "text", nullable: false),
                    GovtIdType = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePerMonth = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParkingSlots_Users_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BlockedDates_ParkingSlots_ParkingSlotId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParkingSlotId = table.Column<int>(type: "integer", nullable: false),
                    SlotNumber = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    VehicleRegNumber = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    ...
                    PaymentGatewayOrderId = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_ParkingSlots_ParkingSlotId",
                        column: x => x.ParkingSlotId,
                        principalTable: "ParkingSlots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlockedDates_ParkingSlotId",
                table: "BlockedDates",
                column: "ParkingSlotId");

            migrationBuilder.CreateIndex(
                name: "IX_Bookings_ParkingSlotId_Status",
                table: "Bookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParkingSlots_City",
                table: "ParkingSlots",
                column: "City");

            migrationBuilder.CreateIndex(
                name: "IX_ParkingSlots_OwnerId",
                table: "ParkingSlots",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_ParkingSlots_Status_IsActive",
                table: "ParkingSlots",
                columns: new[] { "Status", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_ParkingSlotId",
                table: "Reviews",
                column: "ParkingSlotId");
